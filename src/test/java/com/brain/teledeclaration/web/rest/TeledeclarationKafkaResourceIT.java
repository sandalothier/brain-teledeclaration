...
import com.brain.teledeclaration.config.KafkaProperties;
...
class TeledeclarationKafkaResourceIT {
    ...
    void setup() {
        ...
        TeledeclarationKafkaResource kafkaResource = new TeledeclarationKafkaResource(kafkaProperties);
    ...
    void producesMessages() throws Exception {
        restMockMvc
            .perform(post("/api/teledeclaration-kafka/publish/topic-produce?message=value-produce"))
    ...
    void consumesMessages() throws Exception {
        ...
        MvcResult mvcResult = restMockMvc
            .perform(get("/api/teledeclaration-kafka/consume?topic=topic-consume"))
            .andExpect(status().isOk())
