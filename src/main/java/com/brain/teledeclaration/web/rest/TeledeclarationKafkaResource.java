...
@RestController
@RequestMapping("/api/teledeclaration-kafka")
public class TeledeclarationKafkaResource {

    private final Logger log = LoggerFactory.getLogger(TeledeclarationKafkaResource.class);

    private final KafkaProperties kafkaProperties;
    private KafkaProducer<String, String> producer;
    private ExecutorService sseExecutorService = Executors.newCachedThreadPool();

    public TeledeclarationKafkaResource(KafkaProperties kafkaProperties) {
